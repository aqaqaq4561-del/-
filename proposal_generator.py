...
_ALL_PORTFOLIOS = {
    ...
    "교육 통합 관리 플랫폼": ["교육", "학원", "플랫폼", "육아", "복지", "강의", "ERP", "LMS"],
    "IoT 스마트홈 제어 앱": ["IoT", "스마트홈", "부동산", "센서", "블루투스", "디바이스", "하드웨어", "펌웨어", "제어"],
    ...
    "견적 관리 시스템": ["견적", "CRM", "ERP", "관리 시스템", "업무 관리", "자동화", "관리자", "대시보드", "시스템 구축"],
    "현금 결제 플랫폼": ["결제", "현금", "간편결제", "송금", "정산"],
    "발달지원 플랫폼": ["발달", "복지", "지원", "상담", "케어"],
}
